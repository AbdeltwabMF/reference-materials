/** Shortest Path Faster Algorithm :
    ...
    - The maximum k can be V (which is the same as the time complexity of Bellman Fords).
    - However in practice SPFA (which uses a queue) is as fast as Dijkstras (which uses a priority queue).
    ...
    that enters the queue for over V dash 1 times.
**/
