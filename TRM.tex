...
\lstdefinestyle{cpp}{
  ...
  numbersep=6pt,
  showspaces=false,
  otherkeywords={size, front, back, push, cin, cout, endl, pop, queue, stack, sizeof, memset},
...
{
  % list of keywords
  morekeywords={ set, let, map, nmap, filetype, on, off, autocmd, call, syntax, vmap, <leader>, keycode, clear, xmodmap, setxkbmap, g++},
